...
class ArchiveListFilter(admin.SimpleListFilter):
    '''
        This Class Creates a Filter in the Admin Panel which filters based on the
        basis of "is_archived" field
    '''
    ...
    parameter_name = 'is_archived' ## kis value ke hisab se filter karna he vo
...
class TaskStatusListFilter(admin.SimpleListFilter):
    '''
        This Class Creates Filter in the Admin Panel which filters based on the basis of
        "task_status" field
    '''
...
class TaskHistoryAdmin(admin.ModelAdmin):
    '''This defines representation of TaskHistory Model in Admin Interface'''
...
class TaskAdmin(admin.ModelAdmin):
    '''This defines representation of Task Model in the Admin Interface'''
